...
# millionerlar = [ism for ism,pul in people if pul >= 1_000_000]
# print(millionerlar)
#
# def find_millioneer(people):
#     return [ism for ism, pul in people.items()333 if pul >= 1_000_000]
...
# print([[i for i in line.split() if len(i)>5] for line in text.split("\n")])
...
#
# from view
# print((lambda a, c, b=20: a+b+c)(1,2))
#
# 2-usul
...
# https://www.geeksfo-rgeeks.org/reduce-in-python/
#
